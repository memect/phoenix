...
- [docs/skills/release-process/SKILL.md](./skills/release-process/SKILL.md)

详细步骤见：

- [docs/skills/release-process/references/checklist.md](./skills/release-process/references/checklist.md)

如果要复制到本地 agent skill 目录，可直接复制整个 `docs/skills/release-process/` 目录。
